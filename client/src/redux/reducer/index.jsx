    ...
    switch (action.type) {
        ...
        case GET_FILTERS_CONTINENT:
            ...
            return {
                ...
                currentCountries: state.currentCountries.filter(e => e.subregion.region.name === action.payload),
                filterByContinent: state.currentCountries.filter(c => c.subregion.region.name === action.payload)
        ...
        case GET_FILTERS_ACTIVITY:
            ...
            if (state.filterByContinent.length) {
                ...
                return {
                    ...state,
                    currentCountries: state.filterByContinent.filter(e => e.activities.find(ele => ele.name === action.payload))
                }
            }
            return {
                ...state,
                currentCountries: state.currentCountries.filter(e => e.activities.find(ele => ele.name === action.payload))
            }
