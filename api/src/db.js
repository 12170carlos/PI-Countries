...
const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/countries`, { //se hace la conexión entre el back y la db por medio de sequelize
...
const { Country, Activity, Region, Subregion } = sequelize.models;
